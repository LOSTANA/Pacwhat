	...
	public void run() {
		while (true) {
			...
			while (true) {
				...
				Color rightColor = new Color(image.getRGB(player.getX() + 5, player.getY()));
				Color topColor = new Color(image.getRGB(player.getX(), player.getY() - 5));
				Color bottomColor = new Color(image.getRGB(player.getX(), player.getY() + 5));
